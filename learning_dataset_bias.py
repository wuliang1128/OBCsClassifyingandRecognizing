...
class Net1(nn.Module):
    def __init__(self):
        ...
        self.norm1 = nn.LayerNorm([20, 12, 12])
        self.conv2 = nn.Conv2d(20, 50, 5, 1)
        self.norm2 = nn.LayerNorm([50, 4, 4])
...
def main():
    ...
    parser.add_argument('--net', type=str, default='Net1', help='type of network')
