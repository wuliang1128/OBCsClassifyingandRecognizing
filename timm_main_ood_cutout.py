...
import os
import random
from model.timm_mixup_model import *   #把原来的 model 代码换成 timm_mixup_model
...
def get_args():
    ...
    parser.add_argument('--input_size', type=int, default=112, help="size of input for data augmentation")
    ...
    parser.add_argument("--ckpt", type=str, default='timm_224', help='path to save result')

    parser.add_argument('--da_method', type=str, default='inter_mixup',
                        choices=['base', 'intra_mixup', 'inter_mixup', 'inter_mosaic', 'intra_mosaic', 'inter_cutmix', 'intra_cutmix'],
                        help='data augmentation method')
    parser.add_argument("--alpha", type=float, default=0.5, help='hyperparameter alpha for lambda distribution')
    parser.add_argument('--check_augmented_img', type=int, default=0, help='if save the augmented image to check')
